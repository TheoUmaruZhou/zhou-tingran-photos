      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredVideos.map((video, index) => (
          <motion.div
            ...
            className="group relative bg-[#e8e8e8] dark:bg-[#222222] overflow-hidden cursor-pointer hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors duration-300 border border-neutral-300 dark:border-neutral-700"
          >
            {/* 视频封面 */}
            <div className="aspect-video w-full overflow-hidden relative">
              ...
              {/* 时长标签 */}
              <div className="absolute bottom-3 right-3 font-mono text-xs bg-black/70 text-white px-2 py-1 tracking-wider">
                {video.duration}
              </div>
            </div>
            ...
            {/* 视频信息 */}
            <div className="p-5">
              <h3 className="text-lg font-display font-bold text-[#1a1a1a] dark:text-[#ebebeb] mb-2 line-clamp-1">
                {video.title}
              </h3>
