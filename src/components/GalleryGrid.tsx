...
export default function GalleryGrid({
  ...
  return (
    <div id="gallery-grid-root" className="w-full max-w-7xl mx-auto px-6 md:px-12 pb-32">
      <div className="pt-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-8">
            ...
            <h2 className="text-4xl md:text-6xl font-display font-extrabold tracking-tight text-[#1a1a1a] uppercase">
              {headerDetails.title}
              <span className="font-mono text-xl text-neutral-500 font-light block mt-2 uppercase">
                {headerDetails.subtitle}
              </span>
            </h2>
            <p className="mt-6 text-neutral-600 text-lg md:text-xl font-sans font-light leading-relaxed max-w-3xl">
              {headerDetails.intro}
            </p>

            {headerDetails.extra && (
              <div className="mt-6 bg-[#e0e0e0] border border-neutral-300 p-6 max-w-3xl rounded-none">
                <div className="flex items-start gap-3">
                  <Info className="w-5 h-5 text-neutral-500 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-mono text-xs text-neutral-500 uppercase tracking-wider mb-2">
          ...
          <div className="lg:col-span-4 lg:text-right flex flex-col gap-4 justify-end lg:h-full lg:pt-8">
            ...
            {selectedCategory || selectedProject ? (
              <button
                ...
                className="font-mono text-xs uppercase px-4 py-2 border border-neutral-300 text-neutral-500 hover:text-[#1a1a1a] hover:border-[#1a1a1a] transition-all self-start lg:self-end cursor-pointer"
              >
                Clear Filters / 恢复全部
              </button>
            ) : null}
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div id="filter-controls-group" className="flex flex-wrap gap-2 items-center">
          <span className="font-mono text-xs text-neutral-500 uppercase mr-2 flex items-center gap-1">
            ...
            return (
              <button
                ...
                className={`font-mono text-xs px-3 py-1.5 transition-all cursor-pointer ${
                  active
                    ? 'bg-[#1a1a1a] text-[#ebebeb] font-semibold'
                    : 'bg-[#e0e0e0] text-neutral-600 hover:bg-neutral-300 hover:text-[#1a1a1a]'
                }`}
              >
                {label.nameZh}
              </button>
          ...
          <div className="h-4 w-[1px] bg-neutral-300 mx-2 hidden md:block" />
              ...
              <button
                ...
                className={`font-mono text-xs px-3 py-1.5 transition-all cursor-pointer ${
                  active
                    ...
                    : 'bg-[#e0e0e0] text-neutral-600 hover:bg-neutral-300 hover:text-red-600'
                }`}
              >
                专题: {label.nameZh}
              </button>
        ...
        <div className="flex items-center gap-6 self-end md:self-auto shrink-0">
          <label className="flex items-center gap-2 cursor-pointer font-mono text-xs text-neutral-500 hover:text-neutral-700">
            <input
              type="checkbox"
              checked={showTechnicalStats}
              onChange={(e) => setShowTechnicalStats(e.target.checked)}
              className="accent-[#1a1a1a] cursor-pointer bg-neutral-200 border-neutral-300"
            />
            <span>Show EXIF Details</span>
          </label>

          <div className="flex items-center bg-[#e0e0e0] p-1 border border-neutral-300 gap-1">
            <button
              onClick={() => setColsMode(3)}
              title="Dense Grid View"
              className={`p-1.5 cursor-pointer ${
                colsMode === 3 ? 'bg-neutral-300 text-[#1a1a1a]' : 'text-neutral-500 hover:text-neutral-700'
              }`}
            >
            ...
            <button
              ...
              className={`p-1.5 cursor-pointer ${
                colsMode === 2 ? 'bg-neutral-300 text-[#1a1a1a]' : 'text-neutral-500 hover:text-neutral-700'
              }`}
            >
            ...
            <button
              ...
              className={`p-1.5 cursor-pointer ${
                colsMode === 1 ? 'bg-neutral-300 text-[#1a1a1a]' : 'text-neutral-500 hover:text-neutral-700'
              }`}
            >
      ...
      {filteredPhotographs.length === 0 ? (
        <div className="w-full text-center py-24 bg-[#e0e0e0] border border-neutral-300">
          <p className="font-mono text-neutral-500 text-sm">NO SPECIMENS RECORDED IN THIS INDEX ROUTE.</p>
          <button
            onClick={handleResetFilters}
            className="mt-4 font-mono text-xs px-4 py-2 bg-[#1a1a1a] text-[#ebebeb] font-semibold hover:bg-neutral-700"
          >
            Reset Filters
          </button>
        </div>
        ...
        >
          {filteredPhotographs.map((photo) => (
            ...
            >
              <div className="relative w-full overflow-hidden bg-neutral-300 aspect-[4/3] md:aspect-auto">
                <img
                  src={photo.imageUrl}
                  alt={photo.title}
                  loading="lazy"
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#1a1a1a] via-[#1a1a1a]/30 to-transparent p-5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end min-h-[50%]">
                  ...
                  <div className="flex items-center gap-4 mt-3 pt-3 border-t border-neutral-600 font-mono text-[10px] text-neutral-400">
                ...
                <div className="absolute top-3 right-3 font-mono text-[9px] bg-[#1a1a1a]/75 backdrop-blur px-2 py-1 text-neutral-400 opacity-60 group-hover:opacity-100 transition-opacity">
              ...
              <div className="mt-4 flex flex-col justify-start px-1">
                <div className="flex justify-between items-baseline">
                  <h5 className="font-display font-extrabold text-neutral-700 group-hover:text-[#1a1a1a] group-hover:translate-x-1 transition-transform duration-300 uppercase tracking-tight text-sm">
                    {photo.title}
                  </h5>
                ...
                <div className="flex items-center gap-3 font-mono text-[10px] text-neutral-500 mt-1">
                  <span className="text-neutral-400">Location:</span>
                  <span className="truncate">{photo.location}</span>
                </div>

                {showTechnicalStats && (
                  <div className="mt-3 bg-[#e0e0e0] p-3 text-[10px] font-mono border border-neutral-300 text-neutral-600 flex flex-col gap-1">
                    <div className="flex justify-between">
                      <span className="text-neutral-400">BODY:</span>
                      <span>{photo.exif.camera}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-400">GLASS:</span>
